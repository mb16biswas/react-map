...
class Mapcomp extends Component {
  ...
  render() {
    ...
    const positionOrangeIcon1 = [
      this.state.orangeIcon1.lat,
      this.state.orangeIcon1.lng,
    ];
    const positionOrangeIcon2 = [
      this.state.orangeIcon2.lat,
      this.state.orangeIcon2.lng,
    ];
    const positionOrangeIcon3 = [
      this.state.orangeIcon3.lat,
      this.state.orangeIcon3.lng,
    ];
    return (
      // <div className = "map_main">
